 ...
 * @returns {FCRMessage}
 */
export const encodeClientEstablishmentRequest = (
	client_id: NodeID,
	challenge: string,
	ttl: number,
): FCRMessage => {
  ...
  return new FCRMessage(FCRMessageType.ClientEstablishmentRequestType, body)
}
 ...
 */
export const decodeClientEstablishmentResponse = (
  fcrMsg: FCRMessage,
): ClientEstablishmentResponse => {
