...
func TestSecP256K1Equal(t *testing.T) {
	sk, err := hex.DecodeString("56e6c53b6bc55135d1c4cdc1e2ed25e734c466e0c9d01c80490b975e108d7350")
	assert.Empty(t, err)
	sk2, err := hex.DecodeString("56e6c53b6bc55135d1c4cdc1e2ed25e734c466e0c9d01c80490b975e108d7351")
	assert.Empty(t, err)
	sk3, err := hex.DecodeString("56e6c53b6bc55135d1c4cdc1e2ed25e734c466e0c9d01c80490b975e108d7350")
	assert.Empty(t, err)
	assert.False(t, secp256k1Equals(sk, sk2))
	assert.True(t, secp256k1Equals(sk, sk3))
}
