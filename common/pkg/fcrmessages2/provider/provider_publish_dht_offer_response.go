...
func EncodeProviderDHTPublishGroupCIDAck(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ProviderPublishDHTOfferResponseType, body), nil
}

// DecodeProviderDHTPublishGroupCIDAck is used to get the fields from FCRMessage of ProviderDHTPublishGroupCIDAck
func DecodeProviderDHTPublishGroupCIDAck(fcrMsg *fcrmessages2.FCRMessage) (
	int64, // nonce
	string, // signature
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages2.ProviderPublishDHTOfferResponseType {
