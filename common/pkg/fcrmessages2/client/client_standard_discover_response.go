...
func EncodeClientStandardDiscoverResponse(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ClientStandardDiscoverResponseType, body), nil
}

// DecodeClientStandardDiscoverResponse is used to get the fields from FCRMessage of clientStandardDiscoverResponse
func DecodeClientStandardDiscoverResponse(fcrMsg *fcrmessages2.FCRMessage) (
	*cid.ContentID, // piece cid
	...
	if fcrMsg.GetMessageType() != fcrmessages2.ClientStandardDiscoverResponseType {
