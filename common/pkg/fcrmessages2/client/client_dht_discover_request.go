...
func EncodeClientDHTDiscoverRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ClientDHTDiscoverRequestType, body), nil
}

// DecodeClientDHTDiscoverRequest is used to get the fields from FCRMessage of clientDHTDiscoverRequest
func DecodeClientDHTDiscoverRequest(fcrMsg *fcrmessages2.FCRMessage) (
	*cid.ContentID, // piece cid
	...
	if fcrMsg.GetMessageType() != fcrmessages2.ClientDHTDiscoverRequestType {
