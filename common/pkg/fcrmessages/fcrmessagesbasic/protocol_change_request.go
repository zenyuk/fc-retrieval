...
func EncodeProtocolChangeRequest(
	...
	return fcrmessages.CreateFCRMessage(fcrmessages.ProtocolChangeRequestType, body), nil
}

// DecodeProtocolChangeRequest is used to get the fields from FCRMessage of protocolChangeRequest
func DecodeProtocolChangeRequest(fcrMsg *fcrmessages.FCRMessage) (
	int32, // desired version
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages.ProtocolChangeRequestType {
