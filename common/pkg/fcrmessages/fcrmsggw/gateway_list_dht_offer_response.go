...
type gatewayListDHTOfferResponse struct {
	PublishedDHTOffers []fcrmessages.FCRMessage `json:"published_dht_offers"`
}
...
func EncodeGatewayListDHTOfferResponse(
	...
	return fcrmessages.CreateFCRMessage(fcrmessages.GatewayListDHTOfferResponseType, body), nil
}

// DecodeGatewayListDHTOfferResponse is used to get the fields from FCRMessage of GatewayListDHTOfferResponse
func DecodeGatewayListDHTOfferResponse(fcrMsg *fcrmessages.FCRMessage) (
	[]fcrmessages.FCRMessage, // published dht cid offers
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages.GatewayListDHTOfferResponseType {
