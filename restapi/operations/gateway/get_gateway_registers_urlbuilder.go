...
func (o *GetGatewayRegistersURL) WithBasePath(bp string) *GetGatewayRegistersURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetGatewayRegistersURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetGatewayRegistersURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetGatewayRegistersURL")
	}
