...
func NewGetProviderRegistersByIDParams() GetProviderRegistersByIDParams {
	...
	return GetProviderRegistersByIDParams{}
}

// GetProviderRegistersByIDParams contains all the bound params for the get provider registers by Id operation
...
func (o *GetProviderRegistersByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetProviderRegistersByIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
