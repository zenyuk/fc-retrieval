...
type gatewayListDHTOfferAck struct {
	PublishedDHTOffersAck []fcrmessages.FCRMessage `json:"published_dht_offers_ack"`
}

// EncodeGatewayListDHTOfferAck is used to get the FCRMessage of gatewayListDHTOfferAck
func EncodeGatewayListDHTOfferAck(
	publishedDHTOffersAck []fcrmessages.FCRMessage,
	...
	return fcrmessages.CreateFCRMessage(fcrmessages.GatewayListDHTOfferAckType, body), nil
}

// DecodeGatewayListDHTOfferAck is used to get the fields from FCRMessage of gatewayListDHTOfferAck
func DecodeGatewayListDHTOfferAck(fcrMsg *fcrmessages.FCRMessage) (
	[]fcrmessages.FCRMessage, // published dht cid offers ack
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages.GatewayListDHTOfferAckType {
