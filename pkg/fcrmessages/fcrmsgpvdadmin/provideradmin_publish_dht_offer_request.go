...
func EncodeProviderAdminPublishDHTOfferRequest(
	...
	return fcrmessages.CreateFCRMessage(fcrmessages.ProviderAdminPublishDHTOfferRequestType, body), nil
}
...
func DecodeProviderAdminPublishDHTCIDRequest(fcrMsg *fcrmessages.FCRMessage) (
	...
	if fcrMsg.GetMessageType() != fcrmessages.ProviderAdminPublishDHTOfferRequestType {
