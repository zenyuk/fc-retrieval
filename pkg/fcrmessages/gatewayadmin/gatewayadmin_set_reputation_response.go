...
func EncodeGatewayAdminSetReputationResponse(
	...
	return fcrmessages.CreateFCRMessage(fcrmessages.GatewayAdminSetReputationResponseType, body), nil
}

// DecodeGatewayAdminSetReputationResponse is used to get the fields from FCRMessage of gatewayAdminSetReputationResponse
func DecodeGatewayAdminSetReputationResponse(fcrMsg *fcrmessages.FCRMessage) (
	*nodeid.NodeID, // client id
	int64, // reputation
	bool, // exists
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages.GatewayAdminSetReputationResponseType {
