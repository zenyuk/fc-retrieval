...
func EncodeClientEstablishmentResponse(
	...
	return fcrmessages.CreateFCRMessage(fcrmessages.ClientEstablishmentResponseType, body), nil
}

// DecodeClientEstablishmentResponse is used to get the fields from FCRMessage of ClientEstablishmentResponse
func DecodeClientEstablishmentResponse(fcrMsg *fcrmessages.FCRMessage) (
	*nodeid.NodeID, // gateway id
	string, // challenge
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages.ClientEstablishmentResponseType {
