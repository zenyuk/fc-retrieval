...
func EncodeGatewayDHTDiscoverResponse(
	...
	return fcrmessages.CreateFCRMessage(fcrmessages.GatewayDHTDiscoverResponseType, body), nil
}

// DecodeGatewayDHTDiscoverResponse is used to get the fields from FCRMessage of GatewayDHTDiscoverResponse
func DecodeGatewayDHTDiscoverResponse(fcrMsg *fcrmessages.FCRMessage) (
	*cid.ContentID, // piece cid
	...
	if fcrMsg.GetMessageType() != fcrmessages.GatewayDHTDiscoverResponseType {
