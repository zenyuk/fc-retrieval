...
func EncodeClientStandardDiscoverRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ClientStandardDiscoverRequestType, body), nil
}

// DecodeClientStandardDiscoverRequest is used to get the fields from FCRMessage of clientStandardDiscoverRequest
func DecodeClientStandardDiscoverRequest(fcrMsg *fcrmessages2.FCRMessage) (
	*cid.ContentID, // piece cid
	...
	if fcrMsg.GetMessageType() != fcrmessages2.ClientStandardDiscoverRequestType {
