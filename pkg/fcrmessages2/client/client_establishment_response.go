...
func EncodeClientEstablishmentResponse(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ClientEstablishmentResponseType, body), nil
}

// DecodeClientEstablishmentResponse is used to get the fields from FCRMessage of ClientEstablishmentResponse
func DecodeClientEstablishmentResponse(fcrMsg *fcrmessages2.FCRMessage) (
	*nodeid.NodeID, // gateway id
	string, // challenge
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages2.ClientEstablishmentResponseType {
