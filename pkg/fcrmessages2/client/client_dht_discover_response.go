...
type clientDHTDiscoverResponse struct {
	Contacted     []fcrmessages2.FCRMessage `json:"contacted_gateways"`
...
func EncodeClientDHTDiscoverResponse(
	contacted []fcrmessages2.FCRMessage,
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ClientDHTDiscoverResponseType, body), nil
}

// DecodeClientDHTDiscoverResponse is used to get the fields from FCRMessage of ClientDHTDiscoverResponse
func DecodeClientDHTDiscoverResponse(fcrMsg *fcrmessages2.FCRMessage) (
	[]fcrmessages2.FCRMessage, // contacted
	[]nodeid.NodeID, // uncontactable
	int64, // nonce
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages2.ClientDHTDiscoverResponseType {
