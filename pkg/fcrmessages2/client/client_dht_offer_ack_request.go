...
func EncodeClientDHTOfferAckRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ClientDHTOfferAckRequestType, body), nil
}

// DeodeClientDHTOfferAckRequest is used to get the fields from FCRMessage of clientDHTOfferAckRequest
func DeodeClientDHTOfferAckRequest(fcrMsg *fcrmessages2.FCRMessage) (
