...
func EncodeClientEstablishmentRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ClientEstablishmentRequestType, body), nil
}

// DecodeClientEstablishmentRequest is used to get the fields from FCRMessage of clientEstablishmentRequest
func DecodeClientEstablishmentRequest(fcrMsg *fcrmessages2.FCRMessage) (
	*nodeid.NodeID, // client id
	string, // challenge
	int64, // ttl
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages2.ClientEstablishmentRequestType {
