...
func EncodeGatewayDHTDiscoverResponse(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.GatewayDHTDiscoverResponseType, body), nil
}

// DecodeGatewayDHTDiscoverResponse is used to get the fields from FCRMessage of GatewayDHTDiscoverResponse
func DecodeGatewayDHTDiscoverResponse(fcrMsg *fcrmessages2.FCRMessage) (
	*cid.ContentID, // piece cid
	...
	if fcrMsg.GetMessageType() != fcrmessages2.GatewayDHTDiscoverResponseType {
