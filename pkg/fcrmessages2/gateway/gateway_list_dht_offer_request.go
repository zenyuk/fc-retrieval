...
func EncodeGatewayListDHTOfferRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.GatewayListDHTOfferRequestType, body), nil
}

// DecodeGatewayListDHTOfferRequest is used to get the fields from FCRMessage of gatewayListDHTOfferRequest
func DecodeGatewayListDHTOfferRequest(fcrMsg *fcrmessages2.FCRMessage) (
	...
	*fcrmerkletree.FCRMerkleProof, // merkle proof
	...
	if fcrMsg.GetMessageType() != fcrmessages2.GatewayListDHTOfferRequestType {
