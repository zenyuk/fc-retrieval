...
func EncodeGatewayDHTDiscoverRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.GatewayDHTDiscoverRequestType, body), nil
}

// DecodeGatewayDHTDiscoverRequest is used to get the fields from FCRMessage of GatewayDHTDiscoverRequest
func DecodeGatewayDHTDiscoverRequest(fcrMsg *fcrmessages2.FCRMessage) (
	*cid.ContentID, // piece cid
	...
	if fcrMsg.GetMessageType() != fcrmessages2.GatewayDHTDiscoverRequestType {
