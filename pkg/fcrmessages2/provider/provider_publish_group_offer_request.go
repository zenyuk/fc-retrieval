...
func EncodeProviderPublishGroupOfferRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ProviderPublishGroupOfferRequestType, body), nil
}

// DecodeProviderPublishGroupOfferRequest is used to get the fields from FCRMessage of providerPublishGroupOfferRequest
func DecodeProviderPublishGroupOfferRequest(fcrMsg *fcrmessages2.FCRMessage) (
	int64, // nonce
	*cidoffer.CIDOffer, // offer
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages2.ProviderPublishGroupOfferRequestType {
