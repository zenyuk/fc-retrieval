...
func EncodeProviderPublishDHTOfferRequest(
	...
	return fcrmessages2.CreateFCRMessage(fcrmessages2.ProviderPublishDHTOfferRequestType, body), nil
}

// DecodeProviderPublishDHTOfferRequest is used to get the fields from FCRMessage of providerPublishDHTOfferRequest
func DecodeProviderDHTPublishGroupCIDRequest(fcrMsg *fcrmessages2.FCRMessage) (
	int64, // nonce
	*nodeid.NodeID, // provider id
	[]cidoffer.CIDOffer, // offers
	error, // error
) {
	if fcrMsg.GetMessageType() != fcrmessages2.ProviderPublishDHTOfferRequestType {
