...
func NewGetGatewayRegistersByIDParams() GetGatewayRegistersByIDParams {
	...
	return GetGatewayRegistersByIDParams{}
}

// GetGatewayRegistersByIDParams contains all the bound params for the get gateway registers by Id operation
...
func (o *GetGatewayRegistersByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetGatewayRegistersByIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
