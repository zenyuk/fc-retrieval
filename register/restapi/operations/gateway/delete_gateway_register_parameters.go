...
func NewDeleteGatewayRegisterParams() DeleteGatewayRegisterParams {
	...
	return DeleteGatewayRegisterParams{}
}

// DeleteGatewayRegisterParams contains all the bound params for the delete gateway register operation
...
func (o *DeleteGatewayRegisterParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
