...
func (o *GetGatewayRegistersByIDURL) WithBasePath(bp string) *GetGatewayRegistersByIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetGatewayRegistersByIDURL) Build() (*url.URL, error) {
	...
	var _path = "/registers/gateway/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetGatewayRegistersByIDURL")
	}
...
func (o *GetGatewayRegistersByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetGatewayRegistersByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetGatewayRegistersByIDURL")
	}
