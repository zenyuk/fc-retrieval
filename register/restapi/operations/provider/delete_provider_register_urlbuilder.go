...
func (o *DeleteProviderRegisterURL) WithBasePath(bp string) *DeleteProviderRegisterURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteProviderRegisterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProviderRegisterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProviderRegisterURL")
	}
