...
import (
	...
	crypto_facade "github.com/ConsenSys/fc-retrieval/itest/pkg/util/crypto-facade"
...
func TestDHTOfferAck(t *testing.T) {
	...
	for i := 0; i < 32; i++ {
		...
		gatewayRootPubKey, gatewayRetrievalPubKey, gatewayRetrievalPrivateKey, err := crypto_facade.GenerateKeys()
		var idStr string
		if i%2 == 0 {
	...
	for i := 0; i < 3; i++ {
		...
		providerRootPubKey, providerRetrievalPubKey, providerRetrievalPrivateKey, err := crypto_facade.GenerateKeys()
